...
/* eslint-disable @typescript-eslint/no-empty-object-type, react-hooks/immutability */
...
const DropZoneArea = forwardRef<HTMLDivElement, DropZoneAreaProps>(
  ({ className, children, ...props }, forwardedRef) => {
    ...
    return (
      // Keyboard behavior is handled by the nested trigger; this surface owns drag events.
      <div
        ref={(instance) => {
